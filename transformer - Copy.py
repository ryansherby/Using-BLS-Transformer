...
class BLS_transformer:
    ...
    df_dict (dict): A dictionary containing the data for each series.
    json_response (dict): The raw JSON response from the API.
    """

    def __init__(self,series_id:list,registration_key:str=None,start_year:str='2010',end_year:str='2020',config=None):
    ...
    def get_json(self):
        """
        Retrieve data from the Bureau of Labor Statistics API and store it as a raw JSON object.
        Amount of data available to be pulled and number of queries is limited by value of self.registration_key.

        Args:
        None

        Returns:
        dict: A dictionary containing the retrieved JSON as array objects.
        """
        ...
        try:
            print("Response Message: "+self.json_response['message'][0])
        except IndexError:
            None
    ...
    def set_series_catalog_dict(self,i):
